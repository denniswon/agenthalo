...
from newtonswarm.services.cookiefun.cookiefun_client import AgentMetrics, CookieFunClient, Interval, PagedAgentsResponse


class GetCookieMetricsByTwitter(NewtonSwarmToolBase):
    """
...
class GetCookieMetricsByContract(NewtonSwarmToolBase):
    """
    Retrieve AI agent metrics such as mindshare, market cap, price, liquidity, volume, holders,
...
class GetCookieMetricsBySymbol(NewtonSwarmToolBase):
    """
    Retrieve AI agent metrics such as mindshare, market cap, price, liquidity, volume, holders,
...
class GetCookieMetricsPaged(NewtonSwarmToolBase):
    """

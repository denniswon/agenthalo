...
from newtonswarm.services.alchemy import AlchemyClient, HistoricalPriceByAddress, HistoricalPriceBySymbol


class GetAlchemyPriceHistoryBySymbol(NewtonSwarmToolBase):
...
class GetAlchemyPriceHistoryByAddress(NewtonSwarmToolBase):

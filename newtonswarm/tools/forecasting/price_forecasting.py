...
class ForecastTokenPrice(NewtonSwarmToolBase):
    """
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._llm_function = LLMFunctionTemplated.from_files(
            ...
            system_prompt_path=os.path.join(
                BASE_PATH, "newtonswarm", "tools", "forecasting", "prompts", "price_forecasting_system_prompt.md"
            ),
            user_prompt_path=os.path.join(
                BASE_PATH, "newtonswarm", "tools", "forecasting", "prompts", "price_forecasting_user_prompt.md"
            ),
        )

...
from ..agent import NewtonSwarmAgent
from ..agent_client import NewtonSwarmAgentClient, ChatMessage, Context
...
class TelegramBot(TelegramApp, NewtonSwarmAgentClient[Update]):
    def __init__(self, agent: NewtonSwarmAgent, bot_token: str) -> None:
        TelegramApp.__init__(self, bot_token)
        NewtonSwarmAgentClient.__init__(self, agent=agent, client_id="telegram")
    ...
    async def _help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        """Handle /help command"""
        help_message = """🤖 *NewtonSwarm Assistant*
...
You can also just chat with me naturally!"""
    ...
    def _build_welcome_message(self, update: Update) -> str:
        chat_id = self._get_chat_id(update)
        welcome_message = f"""👋 Welcome to NewtonSwarm!

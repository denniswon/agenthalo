...
class NewtonSwarmAgent:

    def __init__(
        self,
        tools: Sequence[NewtonSwarmToolBase],
        model_id: str = "anthropic/claude-3-5-sonnet-20241022",
        system_prompt: Optional[str] = None,
        hints: Optional[str] = None,
    ) -> None:
        """
        Initialize the NewtonSwarmAgent.
        ...
        self._agent = CodeAgent(
            tools=[NewtonSwarmToSmolAgentsToolAdapter.adapt(tool) for tool in tools],

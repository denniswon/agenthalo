from dstack_sdk import DeriveKeyResponse
...
def tappd_key_to_account_info(key: DeriveKeyResponse, chain: str) -> (str, str):
...
async def chain_account_info(chain: str) -> (str, str):

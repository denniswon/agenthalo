...
from agenthalo.services.alchemy import AlchemyClient, HistoricalPriceByAddress, HistoricalPriceBySymbol


class GetAlchemyPriceHistoryBySymbol(AgentHaloToolBase):
...
class GetAlchemyPriceHistoryByAddress(AgentHaloToolBase):

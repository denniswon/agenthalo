...
from agenthalo.config import BASE_PATH
from agenthalo.core.llm import LLMFunctionTemplated
from agenthalo.core.tool import AgentHaloToolBase
from agenthalo.services.alchemy import HistoricalPriceBySymbol
...
class ForecastTokenPrice(AgentHaloToolBase):
    """
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._llm_function = LLMFunctionTemplated.from_files(
            ...
            system_prompt_path=os.path.join(
                BASE_PATH, "agenthalo", "tools", "forecasting", "prompts", "price_forecasting_system_prompt.md"
            ),
            user_prompt_path=os.path.join(
                BASE_PATH, "agenthalo", "tools", "forecasting", "prompts", "price_forecasting_user_prompt.md"
            ),
        )
